...
<b><i>ℹ️ ᴛʏᴘᴇ {help_command} ᴛᴏ ɢᴇᴛ ᴀ ʟɪsᴛ ᴏғ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs</i></b>"""
    ...
    USED_TOKEN = (
        """<b><i>⚠️ ᴛᴇᴍᴘᴏʀᴀʀʏ ᴛᴏᴋᴇɴ ᴀʟʀᴇᴀᴅʏ ᴜsᴇᴅ!</i></b>\n\n<b><i>🔄 ᴋɪɴᴅʟʏ ɢᴇɴᴇʀᴀᴛᴇ ᴀ ɴᴇᴡ ᴏɴᴇ.</i></b>"""
    )
...
┠ <b><i>⬆️ ᴜᴘʟᴏᴀᴅ ᴅᴀᴛᴀ:</i></b> {up_data}
┠ <b><i>⬇️ ᴅᴏᴡɴʟᴏᴀᴅ ᴅᴀᴛᴀ:</i></b> {dl_data}
...
┠ <b><i>⚖️ sʏsᴛᴇᴍ ᴀᴠɢ ʟᴏᴀᴅ :</i></b> {sys_load}
...
------------------------------------------\n\n"""
    ...
    MODE = "<b><i>┠ ⚙️ ᴍᴏᴅᴇ: </i></b>{Mode}\n"

    # ----- LEECH -------
    L_TOTAL_FILES = "<b><i>┠ 📂 ᴛᴏᴛᴀʟ ғɪʟᴇs: </i></b>{Files}\n"
    L_CORRUPTED_FILES = "<b><i>┠ ⚠️ ᴄᴏʀʀᴜᴘᴛᴇᴅ ғɪʟᴇs: </i></b>{Corrupt}\n"
    L_CC = "<b><i>┖ 👤 ʙʏ: </i></b>{Tag}\n\n"
    ...
    SEED_SIZE = "<b><i>\n┠ 📏 sɪᴢᴇ: </i></b>{Size}"
    SEED_SPEED = "<b><i>\n┠ ⚡ sᴘᴇᴇᴅ: </i></b> {Speed} | "
    UPLOADED = "<b><i>⬆️ ᴜᴘʟᴏᴀᴅᴇᴅ: </i></b> {Upload}"
    ...
    STOP_DUPLICATE = (
        "<b><i>⚠️ ғɪʟᴇ/ғᴏʟᴅᴇʀ ɪs ᴀʟʀᴇᴀᴅʏ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴅʀɪᴠᴇ.</i></b>\n<b><i>📋 ʜᴇʀᴇ ᴀʀᴇ {content} ʟɪsᴛ ʀᴇsᴜʟᴛs:</i></b>"
    )
    # ---------------------
...
• <b>-s</b> or <b>-set</b>: <b><i>⚙️ sᴇᴛ ᴅɪʀᴇᴄᴛʟʏ ᴠɪᴀ ᴀʀɢ</i></b>"""
